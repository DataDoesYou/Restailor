...
export const MODEL_OPTIONS: ModelOption[] = [
  ...
  { alias: "GPT-5.4 Mini", provider: "openai", provider_display: "OpenAI", model_id: "gpt-5.4-mini", description: "fast/cheap", legacy_aliases: ["GPT-5.3 Chat", "GPT-5.2 Instant"], legacy_model_ids: ["gpt-5.3-chat-latest", "gpt-5.1-instant", "gpt-5.2-chat-latest"] },
